...
Public Class frmChamberDisplay
    ...
    Private Sub frmChamberDisplay_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '--- there is not Special Order Calendar download or open frmPreSOC window
            If isDownLoadBillorSOC = False Then
                ...
                OwrkOOB = ""
                OwrkCal = "Regular Order"
                OwrkCalCode = 1
                Owork_bill = ""
                Owork_area_text = ""

                wrkOOB = ""
                wrkCal = "Regular Order"
                wrkCalCode = 1
                work_bill = ""
                work_area_text = ""
            End If
            ...
            Dim dsSOC As New DataSet
            Dim k As Integer = 0
            '--- if added Spcial Order Calendar list, reload data information to correspond location 
            If isDownLoadBillorSOC Then
                If tPage0 Then
                    Reload_Bill(wrkText)
                    Me.Calendar.SelectedItem = OwrkCal
                    Me.CurrentCalendar.Text = OwrkCal
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB
                    Me.CurrentOrderOfBusiness.Text = OwrkOOB
                    Me.WorkData.Text = Me.WorkData.Text
                    Me.CurrentBill.Text = Owork_bill
                    Me.Bill.SelectedItem = Owork_bill
                ...
                ElseIf tPage1 Then
                    ...
                    Me.Calendar.SelectedItem = OwrkCal1
                    Me.CurrentCalendar.Text = OwrkCal1
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB1
                    Me.CurrentOrderOfBusiness.Text = OwrkOOB1
                    Me.WorkData1.Text = Me.WorkData1.Text
                    Me.CurrentBill.Text = Owork1_bill
                    Me.Bill.SelectedItem = Owork1_bill
                ...
                ElseIf tPage2 Then
                    ...
                    Me.Calendar.SelectedItem = OwrkCal2
                    Me.CurrentCalendar.Text = OwrkCal2
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB2
                    Me.CurrentOrderOfBusiness.Text = OwrkOOB2
                    Me.WorkData2.Text = Me.WorkData2.Text
                    Me.CurrentBill.Text = Owork2_bill
                    Me.Bill.SelectedItem = Owork2_bill
    ...
    Private Sub ContextMenu_Click(sender As Object, ByVal e As EventArgs)
        Try
    ...
    Private Sub Calendar_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles Calendar.SelectedIndexChanged
        If tPage0 Then
            Me.WorkData.Text = ""
        ElseIf tPage1 Then
            Me.WorkData1.Text = ""
...
continuProcess:  '--- if canceled delete action, reload data to each workarea
            ...
            If tPage0 Then
                ...
                tPage2 = False
                TC.SelectedIndex = 0
                Reload_Bill(Owork_area_text)

                If (wrkCalCode <> OwrkCalCode) And (wrkCal <> OwrkCal) Or (wrkCalCode = OwrkCalCode) And (wrkCal <> OwrkCal) Or (wrkCalCode <> OwrkCalCode And wrkCal = OwrkCal) Then
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB
                    If (wrkCalCode = "SOC" And wrkCal = "Special Order Calendar" And OwrkCal = "Special Order Calendar") Or (wrkCalCode = "1" And wrkCal = "Regular Order" And OwrkCal = "Special Order Calendar") Then
                        initialAfterDeleteSOC()
                    ...
                    If OwrkCal <> "" Then
                        ...
                        Me.CurrentCalendar.Text = wrkCal
                    Else
                        Me.Calendar.SelectedItem = "Regular Order"
                    ...
                    ds0 = V_DataSet("Select * From tblBills Where CalendarCode =( select calendarcode from tblCalendars Where calendar ='" & wrkCal & "') Order By Bill ", "R")
                    Me.Bill.Items.Clear()
                    For Each dr0 In ds0.Tables(0).Rows
                        Me.Bill.Items.Add(dr0("Bill"))
                    Next
                    Me.Bill.SelectedItem = Owork_bill
                    Me.CurrentBill.Text = Owork_bill
                    Me.WorkData.Text = Owork_area_text
                    work_area_text = Owork_area_text
                    wrkOOB = Me.OrderOfBusiness.SelectedItem
                    wrkCal = Me.Calendar.SelectedItem
                    work_bill = Me.CurrentBill.Text
                    wrkCalCode = OwrkCalCode
                    ds0.Dispose()
                Else
                    initialAfterDeleteSOC()
                    Me.WorkData.Text = ""
            ...
            ElseIf tPage1 Then
                ...
                tPage2 = False
                TC.SelectedIndex = 1
                Reload_Bill(Owork_area1_text)

                If ((wrkCalCode1 <> OwrkCalCode1) And (wrkCal1 <> OwrkCal1)) Or (wrkCalCode1 = OwrkCalCode1 And wrkCal1 <> OwrkCal1) Or (wrkCalCode1 <> OwrkCalCode1 And wrkCal1 = OwrkCal1) Then
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB1
                    If (wrkCalCode1 = "SOC" And wrkCal1 = "Special Order Calendar" And OwrkCal1 = "Special Order Calendar") Or (wrkCalCode1 = "1" And wrkCal1 = "Regular Order" And OwrkCal1 = "Special Order Calendar") Then
                        initialAfterDeleteSOC()
                        Me.Bill.SelectedIndex = 0
                        Me.Bill_Click(Bill, Nothing)
                        Me.WorkData1.Text = ""
                    ...
                    If OwrkCal1 <> "" Then
                        ...
                        Me.CurrentCalendar.Text = wrkCal1
                    Else
                        Me.Calendar.SelectedItem = "Regular Order"
                        Me.CurrentCalendar.Text = "Regular Order"
                    End If
                    ...
                    ds1 = V_DataSet("Select * From tblBills Where CalendarCode =( select calendarcode from tblCalendars Where calendar ='" & wrkCal1 & "') Order By Bill ", "R")
                    Me.Bill.Items.Clear()
                    For Each dr1 In ds1.Tables(0).Rows
                        Me.Bill.Items.Add(dr1("Bill"))
                    Next
                    Me.Bill.SelectedItem = Owork1_bill
                    Me.CurrentBill.Text = Owork1_bill
                    Me.WorkData1.Text = Owork_area1_text
                    work_area1_text = Owork_area1_text
                    wrkOOB1 = Me.OrderOfBusiness.SelectedItem
                    wrkCal1 = Me.Calendar.SelectedItem
                    work1_bill = Me.CurrentBill.Text
                    wrkCalCode1 = OwrkCalCode1
                    ds1.Dispose()
                Else
                    initialAfterDeleteSOC()
                    Me.WorkData1.Text = ""
            ...
            ElseIf tPage2 Then
                ...
                tPage2 = True
                TC.SelectedIndex = 2
                Reload_Bill(Owork_area2_text)

                If (wrkCalCode2 <> OwrkCalCode2) And (wrkCal2 <> OwrkCal2) Or (wrkCalCode2 = OwrkCalCode2) And (wrkCal2 <> OwrkCal2) Or (wrkCalCode2 <> OwrkCalCode2 And wrkCal2 = OwrkCal2) Then
                    Me.OrderOfBusiness.SelectedItem = OwrkOOB2
                    If (wrkCalCode2 = "SOC" And wrkCal2 = "Special Order Calendar" And OwrkCal2 = "Special Order Calendar") Or (wrkCalCode2 = "1" And wrkCal2 = "Regular Order" And OwrkCal2 = "Special Order Calendar") Then
                        initialAfterDeleteSOC()
                        Me.Bill.SelectedIndex = 0
                        Me.Bill_Click(Bill, Nothing)
                        Me.WorkData2.Text = ""
                    ...
                    If OwrkCal2 <> "" Then
                        ...
                        Me.CurrentCalendar.Text = wrkCal2
                    Else
                        Me.Calendar.SelectedItem = "Regular Order"
                        Me.CurrentCalendar.Text = "Regular Order"
                    End If
                    ...
                    ds2 = V_DataSet("Select * From tblBills Where CalendarCode =( select calendarcode from tblCalendars Where calendar ='" & wrkCal2 & "') Order By Bill ", "R")
                    Me.Bill.Items.Clear()
                    For Each dr2 In ds2.Tables(0).Rows
                        Me.Bill.Items.Add(dr2("Bill"))
                    Next
                    Me.CurrentBill.Text = Owork2_bill
                    Me.Bill.SelectedItem = Owork2_bill
                    Me.WorkData2.Text = Owork_area2_text
                    work_area2_text = Owork_area2_text
                    wrkOOB2 = Me.OrderOfBusiness.SelectedItem
                    wrkCal2 = Me.Calendar.SelectedItem
                    work2_bill = Me.CurrentBill.Text
                    wrkCalCode2 = OwrkCalCode2
                    ds2.Dispose()
                Else
                    initialAfterDeleteSOC()
                    Me.WorkData2.Text = ""
...
continueNext:
    ...
    Private Sub btnClearWorkArea_MouseDown(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles btnClearWorkArea.MouseDown
    ...
    Private Sub btnClearWorkArea_Click(sender As System.Object, e As System.EventArgs) Handles btnClearWorkArea.Click
        Try
            If tPage0 Then
                WorkData.Text = ""
                work_area_text = ""
    ...
    Private Sub btnDownLoadBills_Click(sender As System.Object, e As System.EventArgs) Handles btnDownLoadBills.Click
        If gNetwork Then
    ...
    Private Sub frmChamberDisplay_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        '--- if window close, initial all of data from tmp variables 
        If isDownLoadBillorSOC = False And straightSOC = False Then
            Me.CurrentBill.Text = ""
            Owork_area_text = ""
            work_area_text = ""
        ...
        If tPage0 Then
            work_bill = Me.CurrentBill.Text
            work_area_text = Me.WorkData.Text
            wrkCal = Me.Calendar.SelectedItem
            wrkOOB = Me.OrderOfBusiness.SelectedItem
            tPage0 = True
            tPage1 = False
        ...
        ElseIf tPage1 Then
            work1_bill = Me.CurrentBill.Text
            work_area1_text = Me.WorkData1.Text
            wrkCal1 = Me.Calendar.SelectedItem
            wrkOOB1 = Me.OrderOfBusiness.SelectedItem
            tPage0 = False
            tPage1 = True
        ...
        ElseIf tPage2 Then
            work2_bill = Me.CurrentBill.Text
            work_area2_text = Me.WorkData2.Text
            wrkCal2 = Me.Calendar.SelectedItem
            wrkOOB2 = Me.OrderOfBusiness.SelectedItem
            tPage0 = False
            tPage1 = False
...
#Region "Three work areas"
    ...
    Private Sub btnDropLastPhrase_Click(sender As System.Object, e As System.EventArgs) Handles btnDropLastPhrase.Click
        If tPage0 Then
            If Strings.Right(Me.WorkData.Text, 2) = vbCrLf Then
    ...
    Private Function GetCalendarCode(calendar As String) As String
        Dim ds As New DataSet
        Try
    ...
    Private Sub TabPage_TextChanged(sender As Object, e As System.EventArgs) Handles TabPage.TextChanged
        wrkText = Me.TabPage.Text
    End Sub

    Private Sub TabPage1_TextChanged(sender As Object, e As System.EventArgs) Handles TabPage1.TextChanged
        wrkText1 = Me.TabPage1.Text
    End Sub

    Private Sub TabPage2_TextChanged(sender As Object, e As System.EventArgs) Handles TabPage2.TextChanged
