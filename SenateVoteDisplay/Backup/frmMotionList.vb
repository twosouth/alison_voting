...
Public Class frmMotionList
    ...
    Private Sub CreateTempTable(ByVal startRecord As Integer, ByVal noOfRecords As Integer)
        ...
        Try
            ...
            If startRecord >= 0 Then
                Adapter.Fill(ds, startRecord, noOfRecords, "tblBills")
                userTable = ds.Tables("tblBills")
            End If
        ...
        userDataGridView.Columns(1).Width = 528
    End Sub
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ds = V_DataSet("Select * From tblBills Where BillNbr='" & userDataGridView.Item(0, userDataGridView.CurrentRow.Index).Value & "' AND CalendarCode='M'", "R")
            ...
            V_DataSet("Insert Into tblBills Values ('M', '" & userDataGridView.Item(0, userDataGridView.CurrentRow.Index).Value & "', '" & userDataGridView.Item(1, userDataGridView.CurrentRow.Index).Value & "', '', '', '','')", "A")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If MessageBox.Show("Do you really want to delete selected record(s)?", "Delete Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2, 0, False) = DialogResult.Yes Then
            Try
                V_DataSet("Delete from tblBills Where BillNbr='" & userDataGridView.CurrentRow.Cells(0).Value & "' AND CalendarCode='M'", "D")
    ...
    Private Sub frmMotionList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            sqlQuery = "Select BillNbr as Code, Bill as Motion FROM tblBills WHERE CalendarCode='M' ORDER BY BillNbr"
            SetDataObjects()
            Connection.Open()
            ...
            tempDataSet.Clear()
            tempDataSet.Dispose()
            Adapter.Fill(tempDataSet, 0, totalRecords, "tblBills")
            userTable = New DataTable("tblBills")
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Try
            V_DataSet("Update tblBills Set CalendarCode='M', BillNbr='" & userDataGridView.Item(0, userDataGridView.CurrentRow.Index).Value & "', Bill='" & userDataGridView.Item(1, userDataGridView.CurrentRow.Index).Value & "', Sponsor='', Subject= '', WorkData='', CalendarPage='' Where BillNbr='" & userDataGridView.Item(0, userDataGridView.CurrentRow.Index).Value & "' AND CalendarCode='M'", "U")
            origValue1 = ""
            origValue2 = ""
        Catch ex As Exception
