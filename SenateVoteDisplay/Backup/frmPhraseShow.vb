...
Public Class frmPhraseShow
    ...
    Private Sub lstPhrase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstPhrase.Click
        ...
        If tPage0 Then
            ...
            tPage1 = False
            tPage2 = False
            If Strings.Right(pWorkData, 2) <> vbCrLf Then
                If pWorkData <> "" Then
                    frmChamberDisplay.WorkData.Text = pWorkData & vbCrLf & strPhrase
                Else
                    frmChamberDisplay.WorkData.Text = strPhrase
                End If
            Else
                frmChamberDisplay.WorkData.Text = pWorkData & strPhrase
            End If
        ElseIf tPage1 Then
            tPage1 = True
            tPage0 = False
            ...
            If Strings.Right(pWorkData2, 2) <> vbCrLf Then
                ...
                End If
            Else
                frmChamberDisplay.WorkData2.Text = pWorkData2 & strPhrase
            End If
            'frmChamberDisplay.WorkData2.Text = pWorkData2 & vbCrLf & strPhrase
        ElseIf tPage2 Then
            tPage2 = True
            ...
            If Strings.Right(pWorkData3, 2) <> vbCrLf Then
                If pWorkData3 <> "" Then
                    frmChamberDisplay.WorkData3.Text = pWorkData3 & vbCrLf & strPhrase
                Else
                    frmChamberDisplay.WorkData3.Text = strPhrase
                End If
            Else
                frmChamberDisplay.WorkData3.Text = pWorkData3 & strPhrase
            End If
        End If
