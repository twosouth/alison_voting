...
Public Class frmPreSOC
    ...
    Private Sub frmPreSOC_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        e.Cancel = True
        Me.Hide()
    End Sub
    ...
    Private Sub frmPreSOC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ' Me.lstSOCCalendar.SelectedIndex = 0
    End Sub
    ...
    Private Sub LoadCalendar()
        ...
        Try
            ...
            strSQL = "Select Bill From tblBills Where CalendarCode='1' Order By Bill"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        If lstSOCCalendar.SelectedIndex <> -1 AndAlso lstSOCCalendar.SelectedIndex < lstSOCCalendar.Items.Count - 1 Then
        ...
        Try
            ...
            If lstSOCBills.Items.Count > 0 Then
                ...
                For i As Integer = 0 To lstSOCBills.Items.Count - 1
                    ...
                    dsBill = V_DataSet("Select * From tblBills Where CalendarCode = '1' and ucase(Bill) ='" & UCase(lstValue) & "'", "R")
                ...
                Dim frmC As New frmChamberDisplay
                frmC.TimerSOC.Enabled = True
                frmC.TimerSOC.Start()
            ...
            End If
        Catch ex As Exception
            DisplayMessage(ex.Message, "Download Special Order Calendar", "S")
        Finally
            dsBill.Dispose()
        End Try
    End Sub
    ...
    Private Function SOCBillExist(ByVal SOCBill As String) As Boolean
        If Me.lstSOCBills.Items.Count > 0 Then
            For j As Integer = 0 To Me.lstSOCBills.Items.Count - 1
                If UCase(SOCBill) = UCase(Me.lstSOCBills.Items(j).ToString) Then
    ...
    Private Sub txtFindSOC_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFindSOC.KeyDown
    ...
    Private Function GetSOCBills(ByVal SRLabel As String, ByVal DocID As String, ByVal SessionOID As Integer) As DataSet
        ...
        Finally
            ds.Dispose()
            dsLocalBills.Dispose()
            cnALIS.Close()
        End Try
    End Function

    Private Sub TabBills_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TabBills.Click
    ...
    Private Sub btnRightSOC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRightSOC.Click
        Dim index As Integer

        Try
            If lstSOCCalendar.SelectedIndex <> -1 Then
                If lstSOCCalendar.SelectedItems.Count > 0 Then
                    For Each item As String In lstSOCCalendar.SelectedItems
                        If SOCBillExist(item) = False Then
                            lstSOCBills.Items.Add(item)
                            index = lstSOCCalendar.Items.IndexOf(item)
                        End If
                    Next
                    lstSOCCalendar.SelectedItems.Clear()
                End If
            End If
            lstSOCCalendar.SelectedIndex = index + 1
        Catch ex As Exception
            Exit Try
        End Try
    End Sub

    Private Sub btnLeftSOC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLeftSOC.Click
        If lstSOCBills.SelectedItems.Count > 0 Then
            Dim copy = lstSOCBills.SelectedItems.OfType(Of String)().ToList()
            For Each item In copy
                lstSOCBills.Items.Remove(item)
            Next
        End If
    End Sub
    ...
    Private Sub btnDeleteSOC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim sw As New Stopwatch
        Dim ds As New DataSet
    ...
    Private Sub txtAddR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtAddR.KeyDown
        If e.KeyCode = Keys.Enter Then
            added = True
            addL = False
            addR = True
    ...
    Private Sub lstSOCCalendar_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstSOCCalendar.DoubleClick
        If lstSOCCalendar.SelectedIndex <> -1 Then
    ...
    Private Sub lstSOCCalendar_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lstSOCCalendar.MouseDown
        If e.Button = Windows.Forms.MouseButtons.Right Then
            lstSOCCalendar.SelectedItems.Clear()
        End If
    End Sub

    Private Sub lstSOCBills_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lstSOCBills.MouseDown
        If e.Button = Windows.Forms.MouseButtons.Right Then
            lstSOCBills.SelectedItems.Clear()
        End If
    End Sub
End Class
...
'    Private Sub frmPreSOC_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
'        e.Cancel = True
'        Me.Hide()
'    End Sub
...
'    Private Sub lstSOCCalendar_DoubleClick(sender As Object, e As System.EventArgs) Handles lstSOCCalendar.DoubleClick
'        If lstSOCCalendar.SelectedIndex <> -1 Then
'            If SOCBillExist(Me.lstSOCCalendar.Items(lstSOCCalendar.SelectedIndex).ToString) = False Then
'                lstSOCBills.Items.Add(lstSOCCalendar.SelectedItem.ToString)
'                If lstSOCBills.Items.Count > 0 Then
...
'    Private Sub lstSOCCalendar_MouseDown(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles lstSOCCalendar.MouseDown
'        If e.Button = Windows.Forms.MouseButtons.Right Then
'            lstSOCCalendar.SelectedItems.Clear()
'        End If
'    End Sub

'    Private Sub lstSOCBills_MouseDown(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles lstSOCBills.MouseDown
'        If e.Button = Windows.Forms.MouseButtons.Right Then
'            lstSOCBills.SelectedItems.Clear()
'        End If
'    End Sub
